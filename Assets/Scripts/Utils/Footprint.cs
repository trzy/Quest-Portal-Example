...
public static class Footprint
{
  ...
  public static Vector3 Measure(GameObject obj)
  {
    ...
    if (sphere != null)
    {
      float lossyScale = Mathf.Max(obj.transform.lossyScale.x, obj.transform.lossyScale.y, obj.transform.lossyScale.z);
      float diameter = 2 * sphere.radius;
      Vector3 size = Vector3.one * diameter * lossyScale;
      Debug.Log("SIZE=" + size.ToString("F3"));
      return size;
    }
